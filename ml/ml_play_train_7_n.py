...
json_file_path = "/Users/mac/ncku/moodle/112-2三下/ML機器學習/swimming-squid-battle/n_7_qtable.json"
class MLPlay:
    ...
    def feature_extract(self, scene_info, mode=1):
        ...
        if mode == 1:
            N = 7 if len(food) >= 7 else len(food)
        elif mode == 2:
            N = 1
        ...
        fuck_score = round(100 * (scene_info['self_lv'] - scene_info['opponent_lv']) * 0.8)
        run_away = -100
        # 計算上下左右
    ...
    def update(self, scene_info: dict, keyboard:list=[], *args, **kwargs):
        ...
        next_state = self.feature_extract(scene_info, mode=1)
        ...
        # print(scene_info['score_to_pass'])
    ...
    def reset(self):
        ...
        print("self.last_frame", self.last_frame)
