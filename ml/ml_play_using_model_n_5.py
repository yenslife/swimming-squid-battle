...
json_file_path = "/Users/mac/ncku/moodle/112-2三下/ML機器學習/swimming-squid-battle/n_5_qtable.json"
class MLPlay:
    ...
    def feature_extract(self, scene_info, mode=1):
        ...
        fuck_score = 20 * (scene_info['self_lv'] - scene_info['opponent_lv'])
        run_away = -100
        # 計算上下左右
    ...
    def update(self, scene_info: dict, keyboard:list=[], *args, **kwargs):
        ...
        actions, max_index = self.get_action(next_state)
